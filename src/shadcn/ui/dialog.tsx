                ...
                {showCloseButton && (
                    <DialogPrimitive.Close
                        ...
                        render={(
                            <Button
                                variant="ghost"
                                className="absolute top-5 inset-e-5 bg-secondary"
                                size="icon-sm"
                            />
                        )}
                    >
